...
2026-09-06，B 的发布候选工程验收已完成。本文公开检查结果和范围；原始日志、研究 PDF、用户库、账号状态及本机路径不随源码公开。B 仓库仍为私有，附件只对有权限的协作者可见。
...
源码提交 `645d41a19fc879b0dd362245aaf8b03f5961651e` 已标记为 `v0.1.0-rc.1`。私有 prerelease：https://github.com/TyrionH-is-coding/codex-scientific-reading/releases/tag/v0.1.0-rc.1 。本次没有重新构建上表的冻结安装包；以后重新构建同版本包时必须重新校验并记录新 SHA，不能继承旧附件的通过结论。自定义 Excel、HTML 模板和文献雷达继续留在 0.2。
