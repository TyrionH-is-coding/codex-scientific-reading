...
for (const file of ['getting-started.md', 'media/dlc-banner.svg', 'media/excel-library-demo.png', 'media/attention-reader.jpg', 'media/README.md']) await copy('docs/' + file);
