...
当前版本为 **[0.1.0-rc.1](https://github.com/TyrionH-is-coding/codex-scientific-reading/releases/tag/v0.1.0-rc.1) 发布候选**。首版支持 Windows x64、PowerShell 5.1+，需要联网安装。无需预装全局 DSH、Node 或 Python。Codex 桌面端必须提供可打开、读取页面的内置浏览器能力；Skill 会实际检查。本仓库已公开，可直接从该 Release 下载 zip 与 `SHA256SUMS.txt`，不要使用 GitHub 自动生成的 Source code 压缩包。
